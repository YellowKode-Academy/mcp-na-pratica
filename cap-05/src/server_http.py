# src/server_http.py -- versao com health e ready endpoints
# Capitulo 5: Transport HTTP/SSE com FastAPI
import json
import time
...
def planejar_serie(genero: str, num_livros: int = 3) -> str:
    ...
    Args:
        genero: O genero da serie
        num_livros: Numero de livros planejados (padrao: 3)
    """
...
4. Estrategia de preco: livro 1 como isca, progressao nos seguintes
5. Recomendacao de Kindle Unlimited vs venda direta
